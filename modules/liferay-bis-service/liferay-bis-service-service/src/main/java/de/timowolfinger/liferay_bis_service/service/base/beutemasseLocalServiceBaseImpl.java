...
import de.timowolfinger.liferay_bis_service.service.beutemasseLocalService;
import de.timowolfinger.liferay_bis_service.service.beutemasseLocalServiceUtil;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.timowolfinger.liferay_bis_service.service.impl.beutemasseLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see de.timowolfinger.liferay_bis_service.service.impl.beutemasseLocalServiceImpl
 * @generated
 */
public abstract class beutemasseLocalServiceBaseImpl
	...
	public beutemasse createbeutemasse(long id) {
		return beutemassePersistence.create(id);
	}
	...
	public beutemasse deletebeutemasse(long id) throws PortalException {
		return beutemassePersistence.remove(id);
	}
	...
	public beutemasse fetchbeutemasse(long id) {
		return beutemassePersistence.fetchByPrimaryKey(id);
	}
	...
	public beutemasse getbeutemasse(long id) throws PortalException {
		return beutemassePersistence.findByPrimaryKey(id);
	}
