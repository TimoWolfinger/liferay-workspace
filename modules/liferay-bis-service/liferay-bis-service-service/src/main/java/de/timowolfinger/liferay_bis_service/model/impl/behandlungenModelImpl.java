...
public class behandlungenModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		{"id", Types.BIGINT}, {"bienenvolk_id", Types.BIGINT},
	...
	public static final String TABLE_SQL_CREATE =
		"create table behandlungen (id LONG not null primary key,bienenvolk_id LONG,dmedikament_id LONG,beginn DATE null,ende DATE null)";

	public static final String TABLE_SQL_DROP = "drop table behandlungen";

	public static final String ORDER_BY_JPQL = " ORDER BY behandlungen.id ASC";

	public static final String ORDER_BY_SQL = " ORDER BY behandlungen.id ASC";
	...
	static {
		...
		attributeGetterFunctions.put("id", behandlungen::getId);
		attributeSetterBiConsumers.put(
			"id", (BiConsumer<behandlungen, Long>)behandlungen::setId);
	...
	public int compareTo(behandlungen behandlungen) {
		...
		if (getId() < behandlungen.getId()) {
			value = -1;
		}
		else if (getId() > behandlungen.getId()) {
			value = 1;
		}
		else {
			value = 0;
	...
	public CacheModel<behandlungen> toCacheModel() {
		...
		behandlungenCacheModel.id = getId();
