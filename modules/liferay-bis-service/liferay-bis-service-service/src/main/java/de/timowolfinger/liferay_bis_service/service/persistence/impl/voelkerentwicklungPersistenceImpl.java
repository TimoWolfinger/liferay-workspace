...
import de.timowolfinger.liferay_bis_service.model.impl.voelkerentwicklungImpl;
import de.timowolfinger.liferay_bis_service.model.impl.voelkerentwicklungModelImpl;
...
public class voelkerentwicklungPersistenceImpl
	...
	public voelkerentwicklungPersistenceImpl() {
		...
		dbColumnNames.put("stockwaage_gewicht_kg", "stockwaage_ewicht_kg");
	 ...
	 */
	@Override
	public voelkerentwicklung remove(long id)
	 ...
	 */
	@Override
	public voelkerentwicklung findByPrimaryKey(long id)
		throws NoSuchvoelkerentwicklungException {
	 ...
	 */
	@Override
	public voelkerentwicklung fetchByPrimaryKey(long id) {
	...
	private static final Set<String> _badColumnNames = SetUtil.fromArray(
		new String[] {"stockwaage_gewicht_kg"});
