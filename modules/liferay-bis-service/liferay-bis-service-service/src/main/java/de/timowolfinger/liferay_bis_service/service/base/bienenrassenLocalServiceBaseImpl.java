 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.timowolfinger.liferay_bis_service.service.impl.bienenrassenLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see de.timowolfinger.liferay_bis_service.service.impl.bienenrassenLocalServiceImpl
 * @generated
 */
public abstract class bienenrassenLocalServiceBaseImpl
	...
	public bienenrassen createbienenrassen(long id) {
		return bienenrassenPersistence.create(id);
	}
	...
	public bienenrassen deletebienenrassen(long id) throws PortalException {
		return bienenrassenPersistence.remove(id);
	}
	...
	public bienenrassen fetchbienenrassen(long id) {
		return bienenrassenPersistence.fetchByPrimaryKey(id);
	}
	...
	public bienenrassen getbienenrassen(long id) throws PortalException {
		return bienenrassenPersistence.findByPrimaryKey(id);
	}
