...
public class medikamenteModelImpl
	...
	public static final String TABLE_SQL_CREATE =
		"create table medikamente (id LONG not null primary key,name VARCHAR(75) null,hersteller_id LONG,dosierung VARCHAR(75) null)";

	public static final String TABLE_SQL_DROP = "drop table medikamente";

	public static final String ORDER_BY_JPQL = " ORDER BY medikamente.id ASC";

	public static final String ORDER_BY_SQL = " ORDER BY medikamente.id ASC";
	...
	static {
		...
		attributeGetterFunctions.put("id", medikamente::getId);
		attributeSetterBiConsumers.put(
			"id", (BiConsumer<medikamente, Long>)medikamente::setId);
	...
	public int compareTo(medikamente medikamente) {
		...
		if (getId() < medikamente.getId()) {
			value = -1;
		}
		else if (getId() > medikamente.getId()) {
			value = 1;
		}
		else {
			value = 0;
	...
	public CacheModel<medikamente> toCacheModel() {
		...
		medikamenteCacheModel.id = getId();
