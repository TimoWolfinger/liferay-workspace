 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.timowolfinger.liferay_bis_service.service.impl.trachtenLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see de.timowolfinger.liferay_bis_service.service.impl.trachtenLocalServiceImpl
 * @generated
 */
public abstract class trachtenLocalServiceBaseImpl
	...
	public trachten createtrachten(long id) {
		return trachtenPersistence.create(id);
	}
	...
	public trachten deletetrachten(long id) throws PortalException {
		return trachtenPersistence.remove(id);
	}
	...
	public trachten fetchtrachten(long id) {
		return trachtenPersistence.fetchByPrimaryKey(id);
	}
	...
	public trachten gettrachten(long id) throws PortalException {
		return trachtenPersistence.findByPrimaryKey(id);
	}
