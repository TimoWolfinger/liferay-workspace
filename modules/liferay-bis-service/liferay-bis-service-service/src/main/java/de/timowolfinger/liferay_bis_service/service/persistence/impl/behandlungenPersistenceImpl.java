...
public class behandlungenPersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			ArgumentsResolver.class, new behandlungenModelArgumentsResolver(),
	...
	private static class behandlungenModelArgumentsResolver
		...
		private Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					...
					arguments[i] = behandlungenModelImpl.getColumnValue(
						columnName);
				}
			}
