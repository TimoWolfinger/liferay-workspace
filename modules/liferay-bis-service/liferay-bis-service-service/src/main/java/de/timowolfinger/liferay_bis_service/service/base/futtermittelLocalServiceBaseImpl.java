...
import de.timowolfinger.liferay_bis_service.service.futtermittelLocalService;
import de.timowolfinger.liferay_bis_service.service.futtermittelLocalServiceUtil;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.timowolfinger.liferay_bis_service.service.impl.futtermittelLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see de.timowolfinger.liferay_bis_service.service.impl.futtermittelLocalServiceImpl
 * @generated
 */
public abstract class futtermittelLocalServiceBaseImpl
	...
	public futtermittel createfuttermittel(long id) {
		return futtermittelPersistence.create(id);
	}
	...
	public futtermittel deletefuttermittel(long id) throws PortalException {
		return futtermittelPersistence.remove(id);
	}
	...
	public futtermittel fetchfuttermittel(long id) {
		return futtermittelPersistence.fetchByPrimaryKey(id);
	}
	...
	public futtermittel getfuttermittel(long id) throws PortalException {
		return futtermittelPersistence.findByPrimaryKey(id);
	}
