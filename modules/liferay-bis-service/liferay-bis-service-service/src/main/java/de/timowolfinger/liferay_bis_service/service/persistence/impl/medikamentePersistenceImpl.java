...
import de.timowolfinger.liferay_bis_service.exception.NoSuchmedikamenteException;
import de.timowolfinger.liferay_bis_service.model.impl.medikamenteImpl;
import de.timowolfinger.liferay_bis_service.model.impl.medikamenteModelImpl;
import de.timowolfinger.liferay_bis_service.model.medikamente;
import de.timowolfinger.liferay_bis_service.model.medikamenteTable;
...
public class medikamentePersistenceImpl
	 ...
	 */
	@Override
	public medikamente remove(long id) throws NoSuchmedikamenteException {
	 ...
	 */
	@Override
	public medikamente findByPrimaryKey(long id)
		throws NoSuchmedikamenteException {
	 ...
	 */
	@Override
	public medikamente fetchByPrimaryKey(long id) {
	...
	public void activate(BundleContext bundleContext) {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			ArgumentsResolver.class, new medikamenteModelArgumentsResolver(),
	...
	private static class medikamenteModelArgumentsResolver
		...
		private Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					...
					arguments[i] = medikamenteModelImpl.getColumnValue(
						columnName);
				}
			}
