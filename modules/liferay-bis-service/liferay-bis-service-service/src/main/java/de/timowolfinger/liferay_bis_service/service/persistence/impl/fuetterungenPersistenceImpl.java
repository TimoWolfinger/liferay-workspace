...
import de.timowolfinger.liferay_bis_service.model.fuetterungenTable;
import de.timowolfinger.liferay_bis_service.model.impl.fuetterungenImpl;
import de.timowolfinger.liferay_bis_service.model.impl.fuetterungenModelImpl;
...
public class fuetterungenPersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			ArgumentsResolver.class, new fuetterungenModelArgumentsResolver(),
	...
	private static class fuetterungenModelArgumentsResolver
		...
		private Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					...
					arguments[i] = fuetterungenModelImpl.getColumnValue(
						columnName);
				}
			}
