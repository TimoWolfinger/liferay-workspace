...
public class bienenvoelkerCacheModel
	...
	public boolean equals(Object object) {
		...
		if (id == bienenvoelkerCacheModel.id) {
			return true;
		}
	...
	public bienenvoelker toEntityModel() {
		...
		bienenvoelkerImpl.setMuttervolk(muttervolk);
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		...
		muttervolk = objectInput.readLong();
	...
	public void writeExternal(ObjectOutput objectOutput) throws IOException {
		...
		objectOutput.writeLong(muttervolk);
