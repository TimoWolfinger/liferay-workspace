 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.timowolfinger.liferay_bis_service.service.impl.honigerntenLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see de.timowolfinger.liferay_bis_service.service.impl.honigerntenLocalServiceImpl
 * @generated
 */
public abstract class honigerntenLocalServiceBaseImpl
	...
	public honigernten createhonigernten(long id) {
		return honigerntenPersistence.create(id);
	}
	...
	public honigernten deletehonigernten(long id) throws PortalException {
		return honigerntenPersistence.remove(id);
	}
	...
	public honigernten fetchhonigernten(long id) {
		return honigerntenPersistence.fetchByPrimaryKey(id);
	}
	...
	public honigernten gethonigernten(long id) throws PortalException {
		return honigerntenPersistence.findByPrimaryKey(id);
	}
