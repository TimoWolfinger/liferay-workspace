...
import de.timowolfinger.liferay_bis_service.service.medikamenteLocalServiceUtil;
...
public abstract class medikamenteLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>medikamenteLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>medikamenteLocalServiceUtil</code>.
	 */
	...
	public void setAopProxy(Object aopProxy) {
		...
		_setLocalServiceUtilService(medikamenteLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = medikamenteLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, medikamenteLocalService);
		}
