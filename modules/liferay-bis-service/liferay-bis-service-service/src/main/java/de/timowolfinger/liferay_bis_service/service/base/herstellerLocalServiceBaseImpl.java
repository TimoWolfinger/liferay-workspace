...
import de.timowolfinger.liferay_bis_service.service.herstellerLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.timowolfinger.liferay_bis_service.service.impl.herstellerLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see de.timowolfinger.liferay_bis_service.service.impl.herstellerLocalServiceImpl
 * @generated
 */
public abstract class herstellerLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>herstellerLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>de.timowolfinger.liferay_bis_service.service.herstellerLocalServiceUtil</code>.
	 */
	...
	public hersteller createhersteller(long id) {
		return herstellerPersistence.create(id);
	}
	...
	public hersteller deletehersteller(long id) throws PortalException {
		return herstellerPersistence.remove(id);
	}
	...
	public hersteller fetchhersteller(long id) {
		return herstellerPersistence.fetchByPrimaryKey(id);
	}
	...
	public hersteller gethersteller(long id) throws PortalException {
		return herstellerPersistence.findByPrimaryKey(id);
	}
