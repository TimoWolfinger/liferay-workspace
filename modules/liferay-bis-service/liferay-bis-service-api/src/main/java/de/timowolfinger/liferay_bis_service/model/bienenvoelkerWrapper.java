...
public class bienenvoelkerWrapper
	...
	public Map<String, Object> getModelAttributes() {
		...
		attributes.put("muttervolk", getMuttervolk());
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		...
		Long muttervolk = (Long)attributes.get("muttervolk");

		if (muttervolk != null) {
			setMuttervolk(muttervolk);
		}
	...
	public void setMuttervolk(long muttervolk) {
		model.setMuttervolk(muttervolk);
	}
