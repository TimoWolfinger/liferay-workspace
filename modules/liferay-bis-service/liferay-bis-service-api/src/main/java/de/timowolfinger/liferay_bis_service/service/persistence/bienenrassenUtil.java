...
public class bienenrassenUtil {
	 ...
	 */
	public static bienenrassen create(long id) {
	 ...
	 */
	public static bienenrassen remove(long id)
	 ...
	 * @throws NoSuchbienenrassenException if a bienenrassen with the primary key could not be found
	 */
	public static bienenrassen findByPrimaryKey(long id)
		throws de.timowolfinger.liferay_bis_service.exception.
			NoSuchbienenrassenException {
	 ...
	 */
	public static bienenrassen fetchByPrimaryKey(long id) {
	...
	private static ServiceTracker
		<bienenrassenPersistence, bienenrassenPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(bienenrassenPersistence.class);

		ServiceTracker<bienenrassenPersistence, bienenrassenPersistence>
			serviceTracker =
				new ServiceTracker
					<bienenrassenPersistence, bienenrassenPersistence>(
						bundle.getBundleContext(),
						bienenrassenPersistence.class, null);
