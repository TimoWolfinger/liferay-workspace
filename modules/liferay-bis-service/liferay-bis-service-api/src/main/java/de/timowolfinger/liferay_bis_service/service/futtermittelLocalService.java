...
public interface futtermittelLocalService
	...
	public futtermittel createfuttermittel(long id);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public futtermittel deletefuttermittel(long id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public futtermittel fetchfuttermittel(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public futtermittel getfuttermittel(long id) throws PortalException;
