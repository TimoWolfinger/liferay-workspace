...
public class bienenvoelkerUtil {
	 ...
	 */
	public static bienenvoelker create(long id) {
	 ...
	 */
	public static bienenvoelker remove(long id)
	 ...
	 * @throws NoSuchbienenvoelkerException if a bienenvoelker with the primary key could not be found
	 */
	public static bienenvoelker findByPrimaryKey(long id)
		throws de.timowolfinger.liferay_bis_service.exception.
			NoSuchbienenvoelkerException {
	 ...
	 */
	public static bienenvoelker fetchByPrimaryKey(long id) {
	...
	private static ServiceTracker
		<bienenvoelkerPersistence, bienenvoelkerPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(bienenvoelkerPersistence.class);

		ServiceTracker<bienenvoelkerPersistence, bienenvoelkerPersistence>
			serviceTracker =
				new ServiceTracker
					<bienenvoelkerPersistence, bienenvoelkerPersistence>(
						bundle.getBundleContext(),
						bienenvoelkerPersistence.class, null);
