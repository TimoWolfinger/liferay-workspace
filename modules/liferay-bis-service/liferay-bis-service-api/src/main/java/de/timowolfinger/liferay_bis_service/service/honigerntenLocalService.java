...
public interface honigerntenLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>de.timowolfinger.liferay_bis_service.service.impl.honigerntenLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the honigernten local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link honigerntenLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public honigernten createhonigernten(long id);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public honigernten deletehonigernten(long id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public honigernten fetchhonigernten(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public honigernten gethonigernten(long id) throws PortalException;
