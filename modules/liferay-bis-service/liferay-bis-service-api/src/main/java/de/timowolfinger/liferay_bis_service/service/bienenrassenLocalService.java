...
public interface bienenrassenLocalService
	...
	public bienenrassen createbienenrassen(long id);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public bienenrassen deletebienenrassen(long id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public bienenrassen fetchbienenrassen(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public bienenrassen getbienenrassen(long id) throws PortalException;
