...
public interface fuetterungenLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>de.timowolfinger.liferay_bis_service.service.impl.fuetterungenLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the fuetterungen local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link fuetterungenLocalServiceUtil} if injection and service tracking are not available.
	 */
