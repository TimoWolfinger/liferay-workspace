...
@ImplementationClassName(
	"de.timowolfinger.liferay_bis_service.model.impl.beutemasseImpl"
)
@ProviderType
public interface beutemasse extends beutemasseModel, PersistedModel {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to <code>de.timowolfinger.liferay_bis_service.model.impl.beutemasseImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public static final Accessor<beutemasse, Long> ID_ACCESSOR =
		new Accessor<beutemasse, Long>() {

			@Override
			public Long get(beutemasse beutemasse) {
				return beutemasse.getId();
			}
