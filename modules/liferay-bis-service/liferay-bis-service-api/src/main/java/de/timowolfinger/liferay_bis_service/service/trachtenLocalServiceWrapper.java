...
public class trachtenLocalServiceWrapper
	 ...
	 */
	@Override
	public de.timowolfinger.liferay_bis_service.model.trachten addtrachten(
	 ...
	 */
	@Override
	public de.timowolfinger.liferay_bis_service.model.trachten createtrachten(
		long id) {

		return _trachtenLocalService.createtrachten(id);
	}
	 ...
	 */
	@Override
	public de.timowolfinger.liferay_bis_service.model.trachten deletetrachten(
			long id)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _trachtenLocalService.deletetrachten(id);
	}
	...
	@Override
	public de.timowolfinger.liferay_bis_service.model.trachten fetchtrachten(
		long id) {

		return _trachtenLocalService.fetchtrachten(id);
	}
	 ...
	 */
	@Override
	public de.timowolfinger.liferay_bis_service.model.trachten gettrachten(
			long id)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _trachtenLocalService.gettrachten(id);
	}
	 ...
	 */
	@Override
	public java.util.List<de.timowolfinger.liferay_bis_service.model.trachten>
	 ...
	 */
	@Override
	public de.timowolfinger.liferay_bis_service.model.trachten updatetrachten(
		de.timowolfinger.liferay_bis_service.model.trachten trachten) {
