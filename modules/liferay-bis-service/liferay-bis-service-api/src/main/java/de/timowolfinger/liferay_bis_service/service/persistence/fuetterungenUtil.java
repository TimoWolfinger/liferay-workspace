...
public class fuetterungenUtil {
	...
	private static ServiceTracker
		<fuetterungenPersistence, fuetterungenPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(fuetterungenPersistence.class);

		ServiceTracker<fuetterungenPersistence, fuetterungenPersistence>
			serviceTracker =
				new ServiceTracker
					<fuetterungenPersistence, fuetterungenPersistence>(
						bundle.getBundleContext(),
						fuetterungenPersistence.class, null);
