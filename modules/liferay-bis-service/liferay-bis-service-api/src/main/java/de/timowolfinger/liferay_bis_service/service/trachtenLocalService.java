...
/**
 * Provides the local service interface for trachten. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see trachtenLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface trachtenLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>de.timowolfinger.liferay_bis_service.service.impl.trachtenLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the trachten local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link trachtenLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public trachten createtrachten(long id);
	...
	public trachten deletetrachten(long id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public trachten fetchtrachten(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public trachten gettrachten(long id) throws PortalException;
