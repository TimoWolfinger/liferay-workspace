...
public class futtermittelLocalServiceUtil {
	 ...
	 */
	public static futtermittel createfuttermittel(long id) {
	 ...
	 */
	public static futtermittel deletefuttermittel(long id)
		throws PortalException {
	...
	public static futtermittel fetchfuttermittel(long id) {
	 ...
	 * @throws PortalException if a futtermittel with the primary key could not be found
	 */
	public static futtermittel getfuttermittel(long id) throws PortalException {
