...
public interface beutemasseLocalService
	...
	public beutemasse createbeutemasse(long id);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public beutemasse deletebeutemasse(long id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public beutemasse fetchbeutemasse(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public beutemasse getbeutemasse(long id) throws PortalException;
