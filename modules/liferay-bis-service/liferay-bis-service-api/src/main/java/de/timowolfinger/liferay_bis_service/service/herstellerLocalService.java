...
/**
 * Provides the local service interface for hersteller. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see herstellerLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface herstellerLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>de.timowolfinger.liferay_bis_service.service.impl.herstellerLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the hersteller local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link herstellerLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public hersteller createhersteller(long id);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public hersteller deletehersteller(long id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public hersteller fetchhersteller(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public hersteller gethersteller(long id) throws PortalException;
