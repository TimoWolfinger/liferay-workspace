...
public class beutemasseUtil {
	 ...
	 */
	public static beutemasse create(long id) {
	 ...
	 */
	public static beutemasse remove(long id)
	 ...
	 * @throws NoSuchbeutemasseException if a beutemasse with the primary key could not be found
	 */
	public static beutemasse findByPrimaryKey(long id)
		throws de.timowolfinger.liferay_bis_service.exception.
			NoSuchbeutemasseException {
	 ...
	 */
	public static beutemasse fetchByPrimaryKey(long id) {
	...
	private static ServiceTracker<beutemassePersistence, beutemassePersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(beutemassePersistence.class);

		ServiceTracker<beutemassePersistence, beutemassePersistence>
			serviceTracker =
				new ServiceTracker
					<beutemassePersistence, beutemassePersistence>(
						bundle.getBundleContext(), beutemassePersistence.class,
						null);
