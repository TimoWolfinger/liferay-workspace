...
public class futtermittelUtil {
	...
	private static ServiceTracker
		<futtermittelPersistence, futtermittelPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(futtermittelPersistence.class);

		ServiceTracker<futtermittelPersistence, futtermittelPersistence>
			serviceTracker =
				new ServiceTracker
					<futtermittelPersistence, futtermittelPersistence>(
						bundle.getBundleContext(),
						futtermittelPersistence.class, null);
