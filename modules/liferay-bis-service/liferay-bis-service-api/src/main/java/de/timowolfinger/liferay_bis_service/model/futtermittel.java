...
@ImplementationClassName(
	"de.timowolfinger.liferay_bis_service.model.impl.futtermittelImpl"
)
@ProviderType
public interface futtermittel extends futtermittelModel, PersistedModel {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to <code>de.timowolfinger.liferay_bis_service.model.impl.futtermittelImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public static final Accessor<futtermittel, Long> ID_ACCESSOR =
		new Accessor<futtermittel, Long>() {

			@Override
			public Long get(futtermittel futtermittel) {
				return futtermittel.getId();
			}
