...
@ImplementationClassName(
	"de.timowolfinger.liferay.beeInformationSystem.model.impl.BehandlungenImpl"
)
@ProviderType
public interface Behandlungen extends BehandlungenModel, PersistedModel {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to <code>de.timowolfinger.liferay.beeInformationSystem.model.impl.BehandlungenImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public static final Accessor<Behandlungen, Long> BEHANDLUNGEN_ID_ACCESSOR =
		new Accessor<Behandlungen, Long>() {

			@Override
			public Long get(Behandlungen behandlungen) {
				return behandlungen.getBehandlungen_id();
			}
