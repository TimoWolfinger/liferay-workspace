...
public class FuetterungenUtil {
	 ...
	 */
	public static Fuetterungen create(long fuetterungen_id) {
		return getPersistence().create(fuetterungen_id);
	}
	 ...
	 */
	public static Fuetterungen remove(long fuetterungen_id)
		throws de.timowolfinger.liferay.beeInformationSystem.exception.
			NoSuchFuetterungenException {

		return getPersistence().remove(fuetterungen_id);
	}
	 ...
	 * @throws NoSuchFuetterungenException if a fuetterungen with the primary key could not be found
	 */
	public static Fuetterungen findByPrimaryKey(long fuetterungen_id)
		throws de.timowolfinger.liferay.beeInformationSystem.exception.
			NoSuchFuetterungenException {

		return getPersistence().findByPrimaryKey(fuetterungen_id);
	}
	 ...
	 */
	public static Fuetterungen fetchByPrimaryKey(long fuetterungen_id) {
		return getPersistence().fetchByPrimaryKey(fuetterungen_id);
	}
