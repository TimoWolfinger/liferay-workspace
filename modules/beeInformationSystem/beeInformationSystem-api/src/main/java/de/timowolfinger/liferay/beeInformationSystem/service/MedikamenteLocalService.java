...
/**
 * Provides the local service interface for Medikamente. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MedikamenteLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MedikamenteLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>de.timowolfinger.liferay.beeInformationSystem.service.impl.MedikamenteLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the medikamente local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MedikamenteLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Medikamente createMedikamente(long medikamente_id);
	...
	public Medikamente deleteMedikamente(long medikamente_id)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Medikamente fetchMedikamente(long medikamente_id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Medikamente getMedikamente(long medikamente_id)
		throws PortalException;
