...
/**
 * Provides the local service utility for Beutemasse. This utility wraps
 * <code>de.timowolfinger.liferay.beeInformationSystem.service.impl.BeutemasseLocalServiceImpl</code> and
 ...
 * @generated
 */
public class BeutemasseLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>de.timowolfinger.liferay.beeInformationSystem.service.impl.BeutemasseLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Beutemasse addBeutemasse(Beutemasse beutemasse) {
		return getService().addBeutemasse(beutemasse);
	}
	 ...
	 */
	public static Beutemasse createBeutemasse(long beutemasse_id) {
		return getService().createBeutemasse(beutemasse_id);
	}
	 ...
	 */
	public static Beutemasse deleteBeutemasse(Beutemasse beutemasse) {
		return getService().deleteBeutemasse(beutemasse);
	}
	 ...
	 */
	public static Beutemasse deleteBeutemasse(long beutemasse_id)
		throws PortalException {

		return getService().deleteBeutemasse(beutemasse_id);
	}
	...
	public static Beutemasse fetchBeutemasse(long beutemasse_id) {
		return getService().fetchBeutemasse(beutemasse_id);
	}
	 ...
	 * @throws PortalException if a beutemasse with the primary key could not be found
	 */
	public static Beutemasse getBeutemasse(long beutemasse_id)
		throws PortalException {

		return getService().getBeutemasse(beutemasse_id);
	}
	 ...
	 */
	public static List<Beutemasse> getBeutemasses(int start, int end) {
	 ...
	 */
	public static Beutemasse updateBeutemasse(Beutemasse beutemasse) {
		return getService().updateBeutemasse(beutemasse);
	}

	public static BeutemasseLocalService getService() {
		return _service;
	}

	private static volatile BeutemasseLocalService _service;
