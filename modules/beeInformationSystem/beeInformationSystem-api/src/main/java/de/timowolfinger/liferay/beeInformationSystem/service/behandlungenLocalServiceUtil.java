 ...
 * <code>de.timowolfinger.liferay.beeInformationSystem.service.impl.behandlungenLocalServiceImpl</code> and
...
public class behandlungenLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>de.timowolfinger.liferay.beeInformationSystem.service.impl.behandlungenLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static behandlungen createbehandlungen(long behandlungen_id) {
		return getService().createbehandlungen(behandlungen_id);
	}
	 ...
	 */
	public static behandlungen deletebehandlungen(long behandlungen_id)
		throws PortalException {

		return getService().deletebehandlungen(behandlungen_id);
	}
	...
	public static behandlungen fetchbehandlungen(long behandlungen_id) {
		return getService().fetchbehandlungen(behandlungen_id);
	}
	 ...
	 * @throws PortalException if a behandlungen with the primary key could not be found
	 */
	public static behandlungen getbehandlungen(long behandlungen_id)
		throws PortalException {

		return getService().getbehandlungen(behandlungen_id);
	}
