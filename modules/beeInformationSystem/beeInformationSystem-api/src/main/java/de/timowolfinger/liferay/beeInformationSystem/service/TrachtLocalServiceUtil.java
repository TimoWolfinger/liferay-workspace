...
/**
 * Provides the local service utility for Tracht. This utility wraps
 * <code>de.timowolfinger.liferay.beeInformationSystem.service.impl.TrachtLocalServiceImpl</code> and
 ...
 * @generated
 */
public class TrachtLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>de.timowolfinger.liferay.beeInformationSystem.service.impl.TrachtLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Tracht addTracht(Tracht tracht) {
		return getService().addTracht(tracht);
	}
	 ...
	 */
	public static Tracht createTracht(long tracht_id) {
		return getService().createTracht(tracht_id);
	}
	 ...
	 */
	public static Tracht deleteTracht(long tracht_id) throws PortalException {
		return getService().deleteTracht(tracht_id);
	}
	 ...
	 * @return the tracht that was removed
	 */
	public static Tracht deleteTracht(Tracht tracht) {
		return getService().deleteTracht(tracht);
	}
	...
	public static Tracht fetchTracht(long tracht_id) {
		return getService().fetchTracht(tracht_id);
	}
	 ...
	 * @throws PortalException if a tracht with the primary key could not be found
	 */
	public static Tracht getTracht(long tracht_id) throws PortalException {
		return getService().getTracht(tracht_id);
	}
	 ...
	 */
	public static List<Tracht> getTrachts(int start, int end) {
		return getService().getTrachts(start, end);
	}
	 ...
	 */
	public static int getTrachtsCount() {
		return getService().getTrachtsCount();
	}
	 ...
	 */
	public static Tracht updateTracht(Tracht tracht) {
		return getService().updateTracht(tracht);
	}

	public static TrachtLocalService getService() {
		return _service;
	}

	private static volatile TrachtLocalService _service;
