...
/**
 * Provides the local service utility for Honigernte. This utility wraps
 * <code>de.timowolfinger.liferay.beeInformationSystem.service.impl.HonigernteLocalServiceImpl</code> and
 ...
 * @generated
 */
public class HonigernteLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>de.timowolfinger.liferay.beeInformationSystem.service.impl.HonigernteLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Honigernte addHonigernte(Honigernte honigernte) {
		return getService().addHonigernte(honigernte);
	}
	 ...
	 */
	public static Honigernte createHonigernte(long honigernte_id) {
		return getService().createHonigernte(honigernte_id);
	}
	 ...
	 */
	public static Honigernte deleteHonigernte(Honigernte honigernte) {
		return getService().deleteHonigernte(honigernte);
	}
	 ...
	 */
	public static Honigernte deleteHonigernte(long honigernte_id)
		throws PortalException {

		return getService().deleteHonigernte(honigernte_id);
	}
	...
	public static Honigernte fetchHonigernte(long honigernte_id) {
		return getService().fetchHonigernte(honigernte_id);
	}
	 ...
	 * @throws PortalException if a honigernte with the primary key could not be found
	 */
	public static Honigernte getHonigernte(long honigernte_id)
		throws PortalException {

		return getService().getHonigernte(honigernte_id);
	}
	 ...
	 */
	public static List<Honigernte> getHonigerntes(int start, int end) {
		return getService().getHonigerntes(start, end);
	}
	 ...
	 */
	public static int getHonigerntesCount() {
		return getService().getHonigerntesCount();
	}
	 ...
	 */
	public static Honigernte updateHonigernte(Honigernte honigernte) {
		return getService().updateHonigernte(honigernte);
	}

	public static HonigernteLocalService getService() {
		return _service;
	}

	private static volatile HonigernteLocalService _service;
