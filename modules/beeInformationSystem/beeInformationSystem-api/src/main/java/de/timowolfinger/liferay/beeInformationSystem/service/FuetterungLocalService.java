...
/**
 * Provides the local service interface for Fuetterung. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FuetterungLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FuetterungLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>de.timowolfinger.liferay.beeInformationSystem.service.impl.FuetterungLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the fuetterung local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FuetterungLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Fuetterung addFuetterung(Fuetterung fuetterung);
	...
	public Fuetterung createFuetterung(long fuetterung_id);
	...
	public Fuetterung deleteFuetterung(Fuetterung fuetterung);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Fuetterung deleteFuetterung(long fuetterung_id)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Fuetterung fetchFuetterung(long fuetterung_id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Fuetterung getFuetterung(long fuetterung_id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Fuetterung> getFuetterungs(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Fuetterung updateFuetterung(Fuetterung fuetterung);
