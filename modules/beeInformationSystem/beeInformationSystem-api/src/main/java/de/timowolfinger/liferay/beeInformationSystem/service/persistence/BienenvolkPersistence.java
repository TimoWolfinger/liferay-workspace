...
/**
 * The persistence interface for the bienenvolk service.
 *
 * <p>
 ...
 */
@ProviderType
public interface BienenvolkPersistence extends BasePersistence<Bienenvolk> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BienenvolkUtil} to access the bienenvolk persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public void cacheResult(java.util.List<Bienenvolk> bienenvolks);
	 ...
	 */
	public java.util.List<Bienenvolk> findAll();
	 ...
	 */
	public java.util.List<Bienenvolk> findAll(int start, int end);
	...
	public java.util.List<Bienenvolk> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<Bienenvolk>
			orderByComparator);
