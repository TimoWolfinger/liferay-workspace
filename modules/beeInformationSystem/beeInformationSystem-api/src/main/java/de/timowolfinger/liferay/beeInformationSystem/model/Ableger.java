...
@ImplementationClassName(
	"de.timowolfinger.liferay.beeInformationSystem.model.impl.AblegerImpl"
)
@ProviderType
public interface Ableger extends AblegerModel, PersistedModel {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to <code>de.timowolfinger.liferay.beeInformationSystem.model.impl.AblegerImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public static final Accessor<Ableger, Long> ABLEGER_ID_ACCESSOR =
		new Accessor<Ableger, Long>() {

			@Override
			public Long get(Ableger ableger) {
				return ableger.getAbleger_id();
			}
