...
@ImplementationClassName(
	"de.timowolfinger.liferay.beeInformationSystem.model.impl.HerstellerImpl"
)
@ProviderType
public interface Hersteller extends HerstellerModel, PersistedModel {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to <code>de.timowolfinger.liferay.beeInformationSystem.model.impl.HerstellerImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public static final Accessor<Hersteller, Long> HERSTELLER_ID_ACCESSOR =
		new Accessor<Hersteller, Long>() {

			@Override
			public Long get(Hersteller hersteller) {
				return hersteller.getHersteller_id();
			}
