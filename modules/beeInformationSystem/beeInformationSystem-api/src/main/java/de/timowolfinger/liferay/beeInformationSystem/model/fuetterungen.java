...
@ImplementationClassName(
	"de.timowolfinger.liferay.beeInformationSystem.model.impl.fuetterungenImpl"
)
@ProviderType
public interface fuetterungen extends fuetterungenModel, PersistedModel {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to <code>de.timowolfinger.liferay.beeInformationSystem.model.impl.fuetterungenImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public static final Accessor<fuetterungen, Long> FUETTERUNGEN_ID_ACCESSOR =
		new Accessor<fuetterungen, Long>() {

			@Override
			public Long get(fuetterungen fuetterungen) {
				return fuetterungen.getFuetterungen_id();
			}
