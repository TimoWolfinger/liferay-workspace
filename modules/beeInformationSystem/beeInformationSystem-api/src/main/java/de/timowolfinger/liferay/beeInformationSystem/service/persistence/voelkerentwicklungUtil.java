...
public class voelkerentwicklungUtil {
	 ...
	 */
	public static voelkerentwicklung create(long voelkerentwicklung_id) {
		return getPersistence().create(voelkerentwicklung_id);
	}
	 ...
	 */
	public static voelkerentwicklung remove(long voelkerentwicklung_id)
		throws de.timowolfinger.liferay.beeInformationSystem.exception.
			NoSuchvoelkerentwicklungException {

		return getPersistence().remove(voelkerentwicklung_id);
	}
	 ...
	 * @throws NoSuchvoelkerentwicklungException if a voelkerentwicklung with the primary key could not be found
	 */
	public static voelkerentwicklung findByPrimaryKey(
			long voelkerentwicklung_id)
		throws de.timowolfinger.liferay.beeInformationSystem.exception.
			NoSuchvoelkerentwicklungException {

		return getPersistence().findByPrimaryKey(voelkerentwicklung_id);
	}
	 ...
	 */
	public static voelkerentwicklung fetchByPrimaryKey(
		long voelkerentwicklung_id) {

		return getPersistence().fetchByPrimaryKey(voelkerentwicklung_id);
	}
