...
public class gesundheitszeugnisseUtil {
	 ...
	 */
	public static gesundheitszeugnisse create(long gesundheitszeugnisse_id) {
		return getPersistence().create(gesundheitszeugnisse_id);
	}
	 ...
	 */
	public static gesundheitszeugnisse remove(long gesundheitszeugnisse_id)
		throws de.timowolfinger.liferay.beeInformationSystem.exception.
			NoSuchgesundheitszeugnisseException {

		return getPersistence().remove(gesundheitszeugnisse_id);
	}
	 ...
	 * @throws NoSuchgesundheitszeugnisseException if a gesundheitszeugnisse with the primary key could not be found
	 */
	public static gesundheitszeugnisse findByPrimaryKey(
			long gesundheitszeugnisse_id)
		throws de.timowolfinger.liferay.beeInformationSystem.exception.
			NoSuchgesundheitszeugnisseException {

		return getPersistence().findByPrimaryKey(gesundheitszeugnisse_id);
	}
	 ...
	 */
	public static gesundheitszeugnisse fetchByPrimaryKey(
		long gesundheitszeugnisse_id) {

		return getPersistence().fetchByPrimaryKey(gesundheitszeugnisse_id);
	}
	...
	private static volatile gesundheitszeugnissePersistence _persistence;
