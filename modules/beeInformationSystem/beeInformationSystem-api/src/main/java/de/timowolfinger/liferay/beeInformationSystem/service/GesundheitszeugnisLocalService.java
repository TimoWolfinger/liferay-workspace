...
/**
 * Provides the local service interface for Gesundheitszeugnis. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see GesundheitszeugnisLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface GesundheitszeugnisLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>de.timowolfinger.liferay.beeInformationSystem.service.impl.GesundheitszeugnisLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the gesundheitszeugnis local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link GesundheitszeugnisLocalServiceUtil} if injection and service tracking are not available.
	 */
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Gesundheitszeugnis> getGesundheitszeugnises(int start, int end);
