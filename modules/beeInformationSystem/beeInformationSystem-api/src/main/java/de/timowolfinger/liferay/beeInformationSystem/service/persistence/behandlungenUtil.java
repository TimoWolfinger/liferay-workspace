...
public class behandlungenUtil {
	 ...
	 */
	public static behandlungen create(long behandlungen_id) {
		return getPersistence().create(behandlungen_id);
	}
	 ...
	 */
	public static behandlungen remove(long behandlungen_id)
		throws de.timowolfinger.liferay.beeInformationSystem.exception.
			NoSuchbehandlungenException {

		return getPersistence().remove(behandlungen_id);
	}
	 ...
	 * @throws NoSuchbehandlungenException if a behandlungen with the primary key could not be found
	 */
	public static behandlungen findByPrimaryKey(long behandlungen_id)
		throws de.timowolfinger.liferay.beeInformationSystem.exception.
			NoSuchbehandlungenException {

		return getPersistence().findByPrimaryKey(behandlungen_id);
	}
	 ...
	 */
	public static behandlungen fetchByPrimaryKey(long behandlungen_id) {
		return getPersistence().fetchByPrimaryKey(behandlungen_id);
	}
