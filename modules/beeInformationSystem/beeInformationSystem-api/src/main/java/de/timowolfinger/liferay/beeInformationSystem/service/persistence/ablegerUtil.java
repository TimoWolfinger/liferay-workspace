...
public class ablegerUtil {
	 ...
	 */
	public static ableger create(long ableger_id) {
		return getPersistence().create(ableger_id);
	}
	 ...
	 * @throws NoSuchablegerException if a ableger with the primary key could not be found
	 */
	public static ableger findByPrimaryKey(long ableger_id)
		throws de.timowolfinger.liferay.beeInformationSystem.exception.
			NoSuchablegerException {

		return getPersistence().findByPrimaryKey(ableger_id);
	}
	 ...
	 */
	public static ableger fetchByPrimaryKey(long ableger_id) {
		return getPersistence().fetchByPrimaryKey(ableger_id);
	}
	...
	private static volatile ablegerPersistence _persistence;
