...
/**
 * Provides the local service interface for Behandlungen. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see BehandlungenLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface BehandlungenLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>de.timowolfinger.liferay.beeInformationSystem.service.impl.BehandlungenLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the behandlungen local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link BehandlungenLocalServiceUtil} if injection and service tracking are not available.
	 */
