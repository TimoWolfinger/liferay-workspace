...
/**
 * Provides the local service interface for Behandlung. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see BehandlungLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface BehandlungLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>de.timowolfinger.liferay.beeInformationSystem.service.impl.BehandlungLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the behandlung local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link BehandlungLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Behandlung addBehandlung(Behandlung behandlung);
	...
	public Behandlung createBehandlung(long behandlung_id);
	...
	public Behandlung deleteBehandlung(Behandlung behandlung);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Behandlung deleteBehandlung(long behandlung_id)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Behandlung fetchBehandlung(long behandlung_id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Behandlung getBehandlung(long behandlung_id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Behandlung> getBehandlungs(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Behandlung updateBehandlung(Behandlung behandlung);
