...
/**
 * The persistence utility for the trachten service. This utility wraps <code>de.timowolfinger.liferay.beeInformationSystem.service.persistence.impl.trachtenPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class trachtenUtil {
	 ...
	 */
	public static trachten create(long trachten_id) {
		return getPersistence().create(trachten_id);
	}
	 ...
	 */
	public static trachten remove(long trachten_id)
		throws de.timowolfinger.liferay.beeInformationSystem.exception.
			NoSuchtrachtenException {

		return getPersistence().remove(trachten_id);
	}
	 ...
	 * @throws NoSuchtrachtenException if a trachten with the primary key could not be found
	 */
	public static trachten findByPrimaryKey(long trachten_id)
		throws de.timowolfinger.liferay.beeInformationSystem.exception.
			NoSuchtrachtenException {

		return getPersistence().findByPrimaryKey(trachten_id);
	}
	 ...
	 */
	public static trachten fetchByPrimaryKey(long trachten_id) {
		return getPersistence().fetchByPrimaryKey(trachten_id);
	}
	...
	private static volatile trachtenPersistence _persistence;
