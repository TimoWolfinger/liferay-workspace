 ...
 * <code>de.timowolfinger.liferay.beeInformationSystem.service.impl.futtermittelLocalServiceImpl</code> and
...
public class futtermittelLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>de.timowolfinger.liferay.beeInformationSystem.service.impl.futtermittelLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static futtermittel addfuttermittel(futtermittel futtermittel) {
	 ...
	 */
	public static futtermittel createfuttermittel(long futtermittel_id) {
		return getService().createfuttermittel(futtermittel_id);
	}
	 ...
	 */
	public static futtermittel deletefuttermittel(futtermittel futtermittel) {
	 ...
	 */
	public static futtermittel deletefuttermittel(long futtermittel_id)
		throws PortalException {

		return getService().deletefuttermittel(futtermittel_id);
	}
	...
	public static futtermittel fetchfuttermittel(long futtermittel_id) {
		return getService().fetchfuttermittel(futtermittel_id);
	}
	 ...
	 * @throws PortalException if a futtermittel with the primary key could not be found
	 */
	public static futtermittel getfuttermittel(long futtermittel_id)
		throws PortalException {

		return getService().getfuttermittel(futtermittel_id);
	}
	 ...
	 */
	public static List<futtermittel> getfuttermittels(int start, int end) {
	 ...
	 */
	public static futtermittel updatefuttermittel(futtermittel futtermittel) {
	...
	private static volatile futtermittelLocalService _service;
