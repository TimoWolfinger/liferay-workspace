...
public interface trachtenLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>de.timowolfinger.liferay.beeInformationSystem.service.impl.trachtenLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the trachten local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link trachtenLocalServiceUtil} if injection and service tracking are not available.
	 */
