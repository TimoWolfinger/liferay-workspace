 ...
 * <code>de.timowolfinger.liferay.beeInformationSystem.service.impl.FuetterungenLocalServiceImpl</code> and
...
public class FuetterungenLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>de.timowolfinger.liferay.beeInformationSystem.service.impl.FuetterungenLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Fuetterungen createFuetterungen(long fuetterungen_id) {
		return getService().createFuetterungen(fuetterungen_id);
	}
	 ...
	 */
	public static Fuetterungen deleteFuetterungen(long fuetterungen_id)
		throws PortalException {

		return getService().deleteFuetterungen(fuetterungen_id);
	}
	...
	public static Fuetterungen fetchFuetterungen(long fuetterungen_id) {
		return getService().fetchFuetterungen(fuetterungen_id);
	}
	 ...
	 * @throws PortalException if a fuetterungen with the primary key could not be found
	 */
	public static Fuetterungen getFuetterungen(long fuetterungen_id)
		throws PortalException {

		return getService().getFuetterungen(fuetterungen_id);
	}
