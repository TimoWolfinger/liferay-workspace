...
/**
 * Provides the local service utility for Behandlung. This utility wraps
 * <code>de.timowolfinger.liferay.beeInformationSystem.service.impl.BehandlungLocalServiceImpl</code> and
 ...
 * @generated
 */
public class BehandlungLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>de.timowolfinger.liferay.beeInformationSystem.service.impl.BehandlungLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Behandlung addBehandlung(Behandlung behandlung) {
		return getService().addBehandlung(behandlung);
	}
	 ...
	 */
	public static Behandlung createBehandlung(long behandlung_id) {
		return getService().createBehandlung(behandlung_id);
	}
	 ...
	 */
	public static Behandlung deleteBehandlung(Behandlung behandlung) {
		return getService().deleteBehandlung(behandlung);
	}
	 ...
	 */
	public static Behandlung deleteBehandlung(long behandlung_id)
		throws PortalException {

		return getService().deleteBehandlung(behandlung_id);
	}
	...
	public static Behandlung fetchBehandlung(long behandlung_id) {
		return getService().fetchBehandlung(behandlung_id);
	}
	 ...
	 * @throws PortalException if a behandlung with the primary key could not be found
	 */
	public static Behandlung getBehandlung(long behandlung_id)
		throws PortalException {

		return getService().getBehandlung(behandlung_id);
	}
	 ...
	 */
	public static List<Behandlung> getBehandlungs(int start, int end) {
		return getService().getBehandlungs(start, end);
	}
	 ...
	 */
	public static int getBehandlungsCount() {
		return getService().getBehandlungsCount();
	}
	 ...
	 */
	public static Behandlung updateBehandlung(Behandlung behandlung) {
		return getService().updateBehandlung(behandlung);
	}

	public static BehandlungLocalService getService() {
		return _service;
	}

	private static volatile BehandlungLocalService _service;
