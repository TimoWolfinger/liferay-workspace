...
@ImplementationClassName(
	"de.timowolfinger.liferay.beeInformationSystem.model.impl.VoelkerentwicklungImpl"
)
@ProviderType
public interface Voelkerentwicklung
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to <code>de.timowolfinger.liferay.beeInformationSystem.model.impl.VoelkerentwicklungImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public static final Accessor<Voelkerentwicklung, Long>
		VOELKERENTWICKLUNG_ID_ACCESSOR =
			new Accessor<Voelkerentwicklung, Long>() {

				@Override
				public Long get(Voelkerentwicklung voelkerentwicklung) {
					return voelkerentwicklung.getVoelkerentwicklung_id();
				}
