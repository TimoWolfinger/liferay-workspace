...
import de.timowolfinger.liferay.beeInformationSystem.service.BehandlungLocalService;
import de.timowolfinger.liferay.beeInformationSystem.service.BehandlungLocalServiceUtil;
...
/**
 * Provides the base implementation for the behandlung local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.timowolfinger.liferay.beeInformationSystem.service.impl.BehandlungLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see de.timowolfinger.liferay.beeInformationSystem.service.impl.BehandlungLocalServiceImpl
 * @generated
 */
public abstract class BehandlungLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, BehandlungLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BehandlungLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>BehandlungLocalServiceUtil</code>.
	 */
	...
	public Behandlung addBehandlung(Behandlung behandlung) {
		...
		return behandlungPersistence.update(behandlung);
	}
	...
	public Behandlung createBehandlung(long behandlung_id) {
		return behandlungPersistence.create(behandlung_id);
	}
	...
	public Behandlung deleteBehandlung(long behandlung_id)
		...
		return behandlungPersistence.remove(behandlung_id);
	}
	...
	public Behandlung deleteBehandlung(Behandlung behandlung) {
		return behandlungPersistence.remove(behandlung);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return behandlungPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Behandlung.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return behandlungPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return behandlungPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return behandlungPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return behandlungPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Behandlung fetchBehandlung(long behandlung_id) {
		return behandlungPersistence.fetchByPrimaryKey(behandlung_id);
	}
	...
	public Behandlung getBehandlung(long behandlung_id) throws PortalException {
		return behandlungPersistence.findByPrimaryKey(behandlung_id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(behandlungLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Behandlung.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("behandlung_id");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			behandlungLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Behandlung.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return behandlungPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return behandlungLocalService.deleteBehandlung(
			(Behandlung)persistedModel);
	}

	@Override
	public BasePersistence<Behandlung> getBasePersistence() {
		return behandlungPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return behandlungPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Behandlung> getBehandlungs(int start, int end) {
		return behandlungPersistence.findAll(start, end);
	}
	...
	public int getBehandlungsCount() {
		return behandlungPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BehandlungLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		behandlungLocalService = (BehandlungLocalService)aopProxy;

		_setLocalServiceUtilService(behandlungLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return BehandlungLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = behandlungPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = BehandlungLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, behandlungLocalService);
		}
	...
	protected BehandlungLocalService behandlungLocalService;
