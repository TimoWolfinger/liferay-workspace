...
import de.timowolfinger.liferay.beeInformationSystem.service.honigerntenService;
import de.timowolfinger.liferay.beeInformationSystem.service.honigerntenServiceUtil;
...
/**
 * Provides the base implementation for the honigernten remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.timowolfinger.liferay.beeInformationSystem.service.impl.honigerntenServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see de.timowolfinger.liferay.beeInformationSystem.service.impl.honigerntenServiceImpl
 * @generated
 */
public abstract class honigerntenServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, honigerntenService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>honigerntenService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>honigerntenServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			honigerntenService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		honigerntenService = (honigerntenService)aopProxy;

		_setServiceUtilService(honigerntenService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return honigerntenService.class.getName();
	}
	...
	private void _setServiceUtilService(honigerntenService honigerntenService) {
		try {
			Field field = honigerntenServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, honigerntenService);
		}
	...
	protected honigerntenService honigerntenService;
