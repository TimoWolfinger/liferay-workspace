...
import de.timowolfinger.liferay.beeInformationSystem.service.bienenrassenService;
import de.timowolfinger.liferay.beeInformationSystem.service.bienenrassenServiceUtil;
...
/**
 * Provides the base implementation for the bienenrassen remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.timowolfinger.liferay.beeInformationSystem.service.impl.bienenrassenServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see de.timowolfinger.liferay.beeInformationSystem.service.impl.bienenrassenServiceImpl
 * @generated
 */
public abstract class bienenrassenServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, bienenrassenService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>bienenrassenService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>bienenrassenServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			bienenrassenService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		bienenrassenService = (bienenrassenService)aopProxy;

		_setServiceUtilService(bienenrassenService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return bienenrassenService.class.getName();
	}
	...
	private void _setServiceUtilService(
		bienenrassenService bienenrassenService) {

		try {
			Field field = bienenrassenServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, bienenrassenService);
		}
	...
	protected bienenrassenService bienenrassenService;
