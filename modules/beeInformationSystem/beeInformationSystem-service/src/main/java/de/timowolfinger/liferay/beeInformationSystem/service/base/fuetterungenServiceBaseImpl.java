...
import de.timowolfinger.liferay.beeInformationSystem.service.fuetterungenService;
import de.timowolfinger.liferay.beeInformationSystem.service.fuetterungenServiceUtil;
...
/**
 * Provides the base implementation for the fuetterungen remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.timowolfinger.liferay.beeInformationSystem.service.impl.fuetterungenServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see de.timowolfinger.liferay.beeInformationSystem.service.impl.fuetterungenServiceImpl
 * @generated
 */
public abstract class fuetterungenServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, fuetterungenService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>fuetterungenService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>fuetterungenServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			fuetterungenService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		fuetterungenService = (fuetterungenService)aopProxy;

		_setServiceUtilService(fuetterungenService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return fuetterungenService.class.getName();
	}
	...
	private void _setServiceUtilService(
		fuetterungenService fuetterungenService) {

		try {
			Field field = fuetterungenServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, fuetterungenService);
		}
	...
	protected fuetterungenService fuetterungenService;
