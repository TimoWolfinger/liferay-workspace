...
import de.timowolfinger.liferay.beeInformationSystem.service.behandlungenService;
import de.timowolfinger.liferay.beeInformationSystem.service.behandlungenServiceUtil;
...
/**
 * Provides the base implementation for the behandlungen remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.timowolfinger.liferay.beeInformationSystem.service.impl.behandlungenServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see de.timowolfinger.liferay.beeInformationSystem.service.impl.behandlungenServiceImpl
 * @generated
 */
public abstract class behandlungenServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, behandlungenService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>behandlungenService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>behandlungenServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			behandlungenService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		behandlungenService = (behandlungenService)aopProxy;

		_setServiceUtilService(behandlungenService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return behandlungenService.class.getName();
	}
	...
	private void _setServiceUtilService(
		behandlungenService behandlungenService) {

		try {
			Field field = behandlungenServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, behandlungenService);
		}
	...
	protected behandlungenService behandlungenService;
