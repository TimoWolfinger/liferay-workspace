...
import de.timowolfinger.liferay.beeInformationSystem.model.gesundheitszeugnisseModel;
...
public class gesundheitszeugnisseModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		{"gesundheitszeugnisse_id", Types.BIGINT},
	...
	static {
		TABLE_COLUMNS_MAP.put("gesundheitszeugnisse_id", Types.BIGINT);
	...
	public static final String TABLE_SQL_CREATE =
		"create table gesundheitszeugnisse (gesundheitszeugnisse_id LONG not null primary key,seriennummer_lt_form VARCHAR(75) null,dokument VARCHAR(75) null,ausstellungsdatum DATE null,dokument_dateityp VARCHAR(75) null)";

	public static final String TABLE_SQL_DROP =
		"drop table gesundheitszeugnisse";

	public static final String ORDER_BY_JPQL =
		" ORDER BY gesundheitszeugnisse.gesundheitszeugnisse_id ASC";
	 ...
	 */
	@Deprecated
	public static final long GESUNDHEITSZEUGNISSE_ID_COLUMN_BITMASK = 1L;
	...
	public long getPrimaryKey() {
		return _gesundheitszeugnisse_id;
	}

	@Override
	public void setPrimaryKey(long primaryKey) {
		setGesundheitszeugnisse_id(primaryKey);
	}
	...
	static {
		...
		attributeGetterFunctions.put(
			...
			gesundheitszeugnisse::getGesundheitszeugnisse_id);
		attributeSetterBiConsumers.put(
			"gesundheitszeugnisse_id",
			(BiConsumer<gesundheitszeugnisse, Long>)
				gesundheitszeugnisse::setGesundheitszeugnisse_id);
		attributeGetterFunctions.put(
	...
	public void setGesundheitszeugnisse_id(long gesundheitszeugnisse_id) {
		...
		_gesundheitszeugnisse_id = gesundheitszeugnisse_id;
	}
	...
	public gesundheitszeugnisse cloneWithOriginalValues() {
		...
		gesundheitszeugnisseImpl.setGesundheitszeugnisse_id(
			this.<Long>getColumnOriginalValue("gesundheitszeugnisse_id"));
		gesundheitszeugnisseImpl.setSeriennummer_lt_form(
	...
	public int compareTo(gesundheitszeugnisse gesundheitszeugnisse) {
		...
		if (getGesundheitszeugnisse_id() <
				gesundheitszeugnisse.getGesundheitszeugnisse_id()) {

			value = -1;
		}
		else if (getGesundheitszeugnisse_id() >
					gesundheitszeugnisse.getGesundheitszeugnisse_id()) {
	...
	private long _gesundheitszeugnisse_id;
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put(
			"gesundheitszeugnisse_id", _gesundheitszeugnisse_id);
		_columnOriginalValues.put(
	...
	static {
		...
		columnBitmasks.put("gesundheitszeugnisse_id", 1L);
