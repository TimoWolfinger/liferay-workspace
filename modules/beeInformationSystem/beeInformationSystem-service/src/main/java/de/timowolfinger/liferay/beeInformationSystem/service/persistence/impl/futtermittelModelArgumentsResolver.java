...
/**
 * The arguments resolver class for retrieving value from futtermittel.
 *
...
@Component(
	immediate = true,
	service = {
		futtermittelModelArgumentsResolver.class, ArgumentsResolver.class
	}
)
public class futtermittelModelArgumentsResolver implements ArgumentsResolver {
	...
	private static Object[] _getValue(
		...
		for (int i = 0; i < arguments.length; i++) {
			...
			if (original) {
				...
				arguments[i] = futtermittelModelImpl.getColumnValue(columnName);
			}
		}
