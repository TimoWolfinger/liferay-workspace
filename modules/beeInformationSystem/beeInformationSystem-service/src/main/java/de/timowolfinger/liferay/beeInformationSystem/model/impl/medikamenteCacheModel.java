...
public class medikamenteCacheModel
	...
	public boolean equals(Object object) {
		...
		if (medikamente_id == medikamenteCacheModel.medikamente_id) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, medikamente_id);
	}
	...
	public medikamente toEntityModel() {
		...
		medikamenteImpl.setMedikamente_id(medikamente_id);
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		medikamente_id = objectInput.readLong();
	...
	public void writeExternal(ObjectOutput objectOutput) throws IOException {
		objectOutput.writeLong(medikamente_id);
