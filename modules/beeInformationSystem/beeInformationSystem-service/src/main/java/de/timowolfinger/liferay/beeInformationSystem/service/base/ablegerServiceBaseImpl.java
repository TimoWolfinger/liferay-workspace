...
import de.timowolfinger.liferay.beeInformationSystem.service.ablegerService;
import de.timowolfinger.liferay.beeInformationSystem.service.ablegerServiceUtil;
...
/**
 * Provides the base implementation for the ableger remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.timowolfinger.liferay.beeInformationSystem.service.impl.ablegerServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see de.timowolfinger.liferay.beeInformationSystem.service.impl.ablegerServiceImpl
 * @generated
 */
public abstract class ablegerServiceBaseImpl
	extends BaseServiceImpl
	implements ablegerService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ablegerService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ablegerServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ablegerService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		ablegerService = (ablegerService)aopProxy;

		_setServiceUtilService(ablegerService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ablegerService.class.getName();
	}
	...
	private void _setServiceUtilService(ablegerService ablegerService) {
		try {
			Field field = ablegerServiceUtil.class.getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, ablegerService);
		}
	...
	protected ablegerService ablegerService;
