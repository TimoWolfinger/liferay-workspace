...
import de.timowolfinger.liferay.beeInformationSystem.service.trachtenService;
import de.timowolfinger.liferay.beeInformationSystem.service.trachtenServiceUtil;
...
/**
 * Provides the base implementation for the trachten remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.timowolfinger.liferay.beeInformationSystem.service.impl.trachtenServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see de.timowolfinger.liferay.beeInformationSystem.service.impl.trachtenServiceImpl
 * @generated
 */
public abstract class trachtenServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, trachtenService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>trachtenService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>trachtenServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			trachtenService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		trachtenService = (trachtenService)aopProxy;

		_setServiceUtilService(trachtenService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return trachtenService.class.getName();
	}
	...
	private void _setServiceUtilService(trachtenService trachtenService) {
		try {
			Field field = trachtenServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, trachtenService);
		}
	...
	protected trachtenService trachtenService;
