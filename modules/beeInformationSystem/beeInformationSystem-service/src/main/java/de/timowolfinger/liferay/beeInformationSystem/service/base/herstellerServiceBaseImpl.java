...
import de.timowolfinger.liferay.beeInformationSystem.service.herstellerService;
import de.timowolfinger.liferay.beeInformationSystem.service.herstellerServiceUtil;
...
/**
 * Provides the base implementation for the hersteller remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.timowolfinger.liferay.beeInformationSystem.service.impl.herstellerServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see de.timowolfinger.liferay.beeInformationSystem.service.impl.herstellerServiceImpl
 * @generated
 */
public abstract class herstellerServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, herstellerService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>herstellerService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>herstellerServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			herstellerService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		herstellerService = (herstellerService)aopProxy;

		_setServiceUtilService(herstellerService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return herstellerService.class.getName();
	}
	...
	private void _setServiceUtilService(herstellerService herstellerService) {
		try {
			Field field = herstellerServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, herstellerService);
		}
	...
	protected herstellerService herstellerService;
