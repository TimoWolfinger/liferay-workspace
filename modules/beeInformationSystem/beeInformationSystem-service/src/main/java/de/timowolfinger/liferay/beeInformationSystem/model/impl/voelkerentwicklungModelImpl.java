...
import de.timowolfinger.liferay.beeInformationSystem.model.voelkerentwicklungModel;
...
public class voelkerentwicklungModelImpl
	...
	public static final String ORDER_BY_JPQL =
		" ORDER BY voelkerentwicklung.voelkerentwicklung_id ASC";
	 ...
	 */
	@Deprecated
	public static final long VOELKERENTWICKLUNG_ID_COLUMN_BITMASK = 1L;
	...
	public void setPrimaryKey(long primaryKey) {
		setVoelkerentwicklung_id(primaryKey);
	}
	...
	static {
		...
		attributeGetterFunctions.put(
			...
			voelkerentwicklung::getVoelkerentwicklung_id);
		attributeSetterBiConsumers.put(
			"voelkerentwicklung_id",
			(BiConsumer<voelkerentwicklung, Long>)
				voelkerentwicklung::setVoelkerentwicklung_id);
		attributeGetterFunctions.put(
	...
	public Object clone() {
		...
		voelkerentwicklungImpl.setVoelkerentwicklung_id(
			getVoelkerentwicklung_id());
	...
	public voelkerentwicklung cloneWithOriginalValues() {
		...
		voelkerentwicklungImpl.setVoelkerentwicklung_id(
			this.<Long>getColumnOriginalValue("voelkerentwicklung_id"));
		voelkerentwicklungImpl.setAnzahl_bebrueteter_rahmen(
		...
		voelkerentwicklungImpl.setStockwaage_gewicht_kg(
			this.<Float>getColumnOriginalValue("stockwaage_gewicht_kg"));
	...
	public int compareTo(voelkerentwicklung voelkerentwicklung) {
		...
		if (getVoelkerentwicklung_id() <
				voelkerentwicklung.getVoelkerentwicklung_id()) {

			value = -1;
		}
		else if (getVoelkerentwicklung_id() >
					voelkerentwicklung.getVoelkerentwicklung_id()) {
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put(
			"voelkerentwicklung_id", _voelkerentwicklung_id);
		_columnOriginalValues.put(
	...
	static {
		...
		columnBitmasks.put("voelkerentwicklung_id", 1L);
		...
		columnBitmasks.put("stockwaage_gewicht_kg", 32L);
