...
import de.timowolfinger.liferay.beeInformationSystem.service.FuetterungLocalService;
import de.timowolfinger.liferay.beeInformationSystem.service.FuetterungLocalServiceUtil;
...
/**
 * Provides the base implementation for the fuetterung local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.timowolfinger.liferay.beeInformationSystem.service.impl.FuetterungLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see de.timowolfinger.liferay.beeInformationSystem.service.impl.FuetterungLocalServiceImpl
 * @generated
 */
public abstract class FuetterungLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, FuetterungLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FuetterungLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FuetterungLocalServiceUtil</code>.
	 */
	...
	public Fuetterung addFuetterung(Fuetterung fuetterung) {
		...
		return fuetterungPersistence.update(fuetterung);
	}
	...
	public Fuetterung createFuetterung(long fuetterung_id) {
		return fuetterungPersistence.create(fuetterung_id);
	}
	...
	public Fuetterung deleteFuetterung(long fuetterung_id)
		...
		return fuetterungPersistence.remove(fuetterung_id);
	}
	...
	public Fuetterung deleteFuetterung(Fuetterung fuetterung) {
		return fuetterungPersistence.remove(fuetterung);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return fuetterungPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Fuetterung.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return fuetterungPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return fuetterungPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return fuetterungPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return fuetterungPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Fuetterung fetchFuetterung(long fuetterung_id) {
		return fuetterungPersistence.fetchByPrimaryKey(fuetterung_id);
	}
	...
	public Fuetterung getFuetterung(long fuetterung_id) throws PortalException {
		return fuetterungPersistence.findByPrimaryKey(fuetterung_id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(fuetterungLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Fuetterung.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("fuetterung_id");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			fuetterungLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Fuetterung.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return fuetterungPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return fuetterungLocalService.deleteFuetterung(
			(Fuetterung)persistedModel);
	}

	@Override
	public BasePersistence<Fuetterung> getBasePersistence() {
		return fuetterungPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return fuetterungPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Fuetterung> getFuetterungs(int start, int end) {
		return fuetterungPersistence.findAll(start, end);
	}
	...
	public int getFuetterungsCount() {
		return fuetterungPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FuetterungLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		fuetterungLocalService = (FuetterungLocalService)aopProxy;

		_setLocalServiceUtilService(fuetterungLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return FuetterungLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = fuetterungPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = FuetterungLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, fuetterungLocalService);
		}
	...
	protected FuetterungLocalService fuetterungLocalService;
