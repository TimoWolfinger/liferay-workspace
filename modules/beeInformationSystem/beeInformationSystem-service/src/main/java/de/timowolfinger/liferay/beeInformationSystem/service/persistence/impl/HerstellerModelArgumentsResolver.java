...
/**
 * The arguments resolver class for retrieving value from Hersteller.
 *
...
@Component(
	immediate = true,
	service = {HerstellerModelArgumentsResolver.class, ArgumentsResolver.class}
)
public class HerstellerModelArgumentsResolver implements ArgumentsResolver {
	...
	public Object[] getArguments(
		...
		if (finderPathColumnBitmask == null) {
			...
			for (String columnName : columnNames) {
				finderPathColumnBitmask |= herstellerModelImpl.getColumnBitmask(
					columnName);
			}

			if (finderPath.isBaseModelResult() &&
				(HerstellerPersistenceImpl.
	...
	private static Object[] _getValue(
		...
		for (int i = 0; i < arguments.length; i++) {
			...
			if (original) {
				...
				arguments[i] = herstellerModelImpl.getColumnValue(columnName);
			}
		}
