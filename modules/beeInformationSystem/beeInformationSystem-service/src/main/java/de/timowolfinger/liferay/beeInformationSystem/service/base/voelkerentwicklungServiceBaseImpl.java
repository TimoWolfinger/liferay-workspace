...
import de.timowolfinger.liferay.beeInformationSystem.service.voelkerentwicklungService;
import de.timowolfinger.liferay.beeInformationSystem.service.voelkerentwicklungServiceUtil;
...
/**
 * Provides the base implementation for the voelkerentwicklung remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.timowolfinger.liferay.beeInformationSystem.service.impl.voelkerentwicklungServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see de.timowolfinger.liferay.beeInformationSystem.service.impl.voelkerentwicklungServiceImpl
 * @generated
 */
public abstract class voelkerentwicklungServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, voelkerentwicklungService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>voelkerentwicklungService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>voelkerentwicklungServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			voelkerentwicklungService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		voelkerentwicklungService = (voelkerentwicklungService)aopProxy;

		_setServiceUtilService(voelkerentwicklungService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return voelkerentwicklungService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = voelkerentwicklungServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, voelkerentwicklungService);
		}
	...
	protected voelkerentwicklungService voelkerentwicklungService;
