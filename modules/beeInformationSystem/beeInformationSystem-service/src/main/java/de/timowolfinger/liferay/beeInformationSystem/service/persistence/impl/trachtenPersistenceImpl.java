...
import de.timowolfinger.liferay.beeInformationSystem.service.persistence.trachtenUtil;
...
public class trachtenPersistenceImpl
	...
	public trachten create(long trachten_id) {
		...
		trachten.setPrimaryKey(trachten_id);
	...
	public trachten remove(long trachten_id) throws NoSuchtrachtenException {
		return remove((Serializable)trachten_id);
	}
	...
	public trachten findByPrimaryKey(long trachten_id)
		...
		return findByPrimaryKey((Serializable)trachten_id);
	}
	...
	public trachten fetchByPrimaryKey(long trachten_id) {
		return fetchByPrimaryKey((Serializable)trachten_id);
	}
